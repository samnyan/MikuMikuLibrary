...
public class GLShaderProgram : IDisposable
{
    ...
    public void SetUniform(string name, Matrix4x4 value) =>
        GL.UniformMatrix4(GetUniformLocation(name), false, ref Unsafe.As<Matrix4x4, OpenTK.Mathematics.Matrix4>(ref value));

    public void SetUniform(string name, bool value) =>
        GL.Uniform1(GetUniformLocation(name), value ? 1 : 0);

    public void SetUniform(string name, Vector4 value) =>
        GL.Uniform4(GetUniformLocation(name), ref Unsafe.As<Vector4, OpenTK.Mathematics.Vector4>(ref value));
    
    public void SetUniform(string name, Vector3 value) =>
        GL.Uniform3(GetUniformLocation(name), ref Unsafe.As<Vector3, OpenTK.Mathematics.Vector3>(ref value));
