...
public sealed class FgoSelSvtTableNode : BinaryFileNode<FgoSelSvtTable>
{
    ...
    public FgoSelSvtTableNode(string name, FgoSelSvtTable data) : base(name, data) { }
    public FgoSelSvtTableNode(string name, Func<Stream> streamGetter) : base(name, streamGetter) { }
}
